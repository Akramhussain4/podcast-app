...
public final class AppConstants {
    ...
    public static final String HEALTH_GENRE = "1307";
    public static final String SCIENCE_GENRE = "1315";
    public static final String SPORTS_GENRE = "1316";
    public static final String TECH_GENRE = "1318";
    ...
    public static final String SHARE_KEY = "shareLink";
